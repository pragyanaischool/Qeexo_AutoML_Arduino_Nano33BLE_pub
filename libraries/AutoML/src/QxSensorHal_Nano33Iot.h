...
#ifndef QXSENSORHAL_NANO_33IOT_H_
#define QXSENSORHAL_NANO_33IOT_H_
...
tQxStatus Sensor_I2CReadRegs(uint8_t address, uint8_t reg, uint8_t *data, uint8_t len);

tQxStatus lsm6ds3_acc_init(struct QxSensorDevice_t *dev);
tQxStatus lsm6ds3_acc_enable(struct QxSensorDevice_t *dev, float fs, float odr, BOOL fifo);

tQxStatus lsm6ds3_gyro_init(struct QxSensorDevice_t *dev);
tQxStatus lsm6ds3_gyro_enable(struct QxSensorDevice_t *dev, float fs, float odr, BOOL fifo);
